...
-- ----------------------------
-- Sequence structure for contas_pagar_id_seq2
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."contas_pagar_id_seq2";
CREATE SEQUENCE "public"."contas_pagar_id_seq2" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
-- ----------------------------
-- Sequence structure for contas_receber_id_seq2
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."contas_receber_id_seq2";
CREATE SEQUENCE "public"."contas_receber_id_seq2" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
-- ----------------------------
-- Sequence structure for pessoa_id_seq2
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."pessoa_id_seq2";
CREATE SEQUENCE "public"."pessoa_id_seq2" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
-- ----------------------------
ALTER TABLE "public"."usuario" ADD CONSTRAINT "usuario_pkey" PRIMARY KEY ("email");
